const COUNTRIES_TEXT = '1=פרו, 2=ארגנטינה, 3=ברזיל';
const INTERESTS_TEXT = 'תרבות, היסטוריה, טבע, נוף, אוכל, אמנות, אדריכלות, חוף, הליכה, צילום, חיי לילה, קניות';

const TRIP_CHAT_SYSTEM_PROMPT = `את/ה עוזר/ת תכנון טיולים ידידותי/ת לאפליקציית טיולים בדרום אמריקה (פרו, ארגנטינה, ברזיל).
...
- countryId: מספר 1, 2 או 3 בלבד, לפי המדינות: ${COUNTRIES_TEXT}. אין מדינות אחרות באפליקציה - אם המשתמש מבקש יעד אחר (למשל צ'ילה), הסבר בעדינות שאפשר לבחור רק מבין שלוש המדינות האלו.
...
{
  "reply": "איזה כיף! לאן תרצה/י לטוס - פרו, ארגנטינה או ברזיל?",
  "status": "collecting",
