...
const auth_router        = require('./routes/auth_r');       // NEW (Assignment 3)
const settings_router    = require('./routes/settings_r');   // NEW (Assignment 3)
...
app.use('/api/auth',        auth_router);       // NEW (Assignment 3)
app.use('/api/settings',    settings_router);   // NEW (Assignment 3)
